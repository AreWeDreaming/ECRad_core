...
mkdir $SYS #For some reason creating the system folder crashes the make process
...
#f2py -c src/ECRad_python.pyf $SYS/ECRad_python.o $SYS/libECRadIDA.a -m ECRad_python -I$SYS/modiIDA/ -L$SYS/ -lECRadIDA
